...
<html lang="en">
    ...
    <body>
            ...
            <div class="header-wrapper">
                ...
                <div class="nav" id="left-menu-php">
                    <nav>
                        ...
                        <ul class="nav-links">
                            <li><i class='bx bxs-home' id="home-php"></i><a class="verde" href="../php/index.php">Inicio</a></li>
                            <hr class="linea">
                            <li><i class='bx bxs-book-reader' id="book-php"></i><a class="verde" href="../php/index.php#fondo-who">¿Quiénes Somos?</a></li>
                            <hr class="linea">
                            <li id="beneficios"><i class='bx bxs-medal' id="medal-php"></i><a class="verde">Recompensas</a></li>
                            <hr class="linea">
                            <li><i class='bx bxs-star' id="star-php"></i><a class="verde" href="../php/index.php#fondo-serv">¿Qué ofrecemos?</a></li>
                            <hr class="linea">
                            <li><i class='bx bxs-message-detail' id="message-php"></i><a class="verde">Foro</a></li>
                            <hr class="linea">
                        </ul>
                    </nav>
                </div>
        ...
        <div class="banner-wrapper" id="fondo-main">
            <div class="banner">
                ...
                <div class="doble-btn btn1">
                    <button>Mapa de reciclaje</button>
        ...
        <div class="main-wrapper">
            ...
            <div class="main-foto">
                <img src="../assets/img/fotomokup.png" alt="Persona reciclando">
            </div>
        </div>
            ...
            <div class="options-wrapper">
                <div class="frames">
                    <div class="img-option-serv">
                        <img src="../assets/img/fotomokup.png" alt="guia">
                    </div>
                ...
                <div class="frames">
                    <div class="img-option-serv">
                        <img src="../assets/img/fotomokup.png" alt="mapa" class="img-size">
                    </div>
                    <div class="btn-option">
                        <button>Mapa</button>
                    </div>
                ...
                <div class="frames">
                    <div class="img-option-serv">
                        <img src="../assets/img/fotomokup.png" alt="foro">
                    </div>
                    <div class="btn-option">
                        <a><button>Foro</button></a>
                    </div>
                </div>
                
                <div class="frames">
                    <div class="img-option-serv">
                        <img src="../assets/img/fotomokup.png" alt="recompensas">
                    </div>
                    <div class="btn-option">
                        <a><button>Recompensas</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="recicle-wrapper">
                <div class="options-line">
                    <div class="img-option">
                        <img src="../assets/img/guia-clasificacion-icons/fotomokup.png" alt="">
        ...
        <div class="main-mapa-wrapper">
            ...
            <div class="google-maps">
                <img src="../assets/img/fotomokup.png" alt="">
            </div>
        </div>
    ...
    <div class="wraper-footer">
        ...
        <div class="contacto-wrapper">
            <div class="lista-contacto">
                <ul>
                    <li> <box-icon name="envelope"></box-icon><a>Ecogestion@gmail.com</a></li>
                    <li> <box-icon name="phone"></box-icon> <a>+569 12345678</a></li>
                    <li> <box-icon name="map"></box-icon> <a>Viel 3414</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="lista-wrapper">
            <div class="lista-servicio">
                <ul>
                    <li> <box-icon name="map-alt"></box-icon> <a>Mapa de reciclaje</a></li>
                    <li> <box-icon name="book-content"></box-icon> <a>Guía de reciclaje</a></li>
                    <li> <box-icon name="smile"></box-icon> <a>Foro</a></li>
                    <li> <box-icon name="trophy"></box-icon> <a>Recompensas</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="cuenta-wrapper">
            <div class="lista-cuenta">
                <ul>
                    <li> <box-icon name="user"></box-icon> <a>Iniciar sesión</a> </li>
                    <li> <box-icon name="user-plus"></box-icon> <a>Registrarse</a></li>
                    <li> <box-icon name="star"></box-icon> <a>Beneficios disponibles</a></li>
                </ul>
            </div>
        </div>
    </div>
